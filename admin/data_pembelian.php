        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="data_pembelian.php?user=<?php echo $user; ?>" class=" nav-link">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <form action="data_pembelian.php" method="get" class="float-right d-none d-sm-inline-block">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['cari'])) {
                                                $cari = $_GET['cari'];
                                                $data = mysqli_query($mysqli, "SELECT A.id_pembeli, A.nama, A.umur, B.id_pembayaran, B.nama_obat, B.kode_obat, B.fungsi, B.harga, C.kode_obat, C.bukti FROM pelanggan A INNER JOIN transaksi B ON A.id_pelanggan = B.id_pelanggan INNER JOIN boking C ON C.id_pembayaran = C.id_booking where pelanggan like '%" . $cari . "%'");
                                            
                                            } else {

                                                $data = mysqli_query($mysqli, "SELECT A.id_pelanggan, A.nama, A.telp, B.id_pembayaran, B.lapangan, B.jns_lapangan, B.jam, B.tanggal, C.id_booking, C.bukti FROM pelanggan A INNER JOIN transaksi B ON A.id_pelanggan = B.id_pelanggan INNER JOIN boking C ON C.id_pembayaran = C.id_booking");
                                            }
                                            ...
                                            ?>
                                                <td align='center'><a href="edit_pembelian.php?id_pelanggan=<?php echo $user_data['id_pelanggan']; ?>">Edit</a></td>
                                                <td align='center'><a href="hapus_pembelian.php?id_pelanggan=<?php echo $user_data['id_pelanggan']; ?>">Delete</a></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
